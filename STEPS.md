...
> A fully-serverless, cloud-native application that generates ATS-optimized CVs and analyzes their compatibility with job descriptions — built, deployed, and tested end-to-end on AWS.
...
Successfully generated a CV, stored it in S3, and ran the JD analyzer end-to-end — returned a real match score with missing-keyword suggestions against an actual job description. See `screenshots/16-fulltest.png`.
